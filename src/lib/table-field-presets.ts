...
export const tableFieldPresetGroups: TableFieldPresetGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "adSentDate", label: "AD sent date" },
      { key: "adVettingDate", label: "AD Vetting date" },
      { key: "rqaSentDate", label: "R&QA sent date" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "preBidMeeting", label: "Pre-Bid Meeting (Yes/No)" },
      ...
      { key: "refloatPreBidMeeting", label: "Refloat Pre-Bid Meeting (Yes/No)" },
      { key: "refloatPreBidMeetingDate", label: "Refloat Pre-Bid Meeting date" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "warrantyPeriodDate", label: "Warranty period" },
  ...
  },
  {
    title: "Firm details",
    fields: [
      { key: "invitedFirmNames", label: "Invited firm names" },
      { key: "invitedFirmUniqueNos", label: "Invited firm unique nos." },
      { key: "invitedFirmEmails", label: "Invited firm emails" },
      { key: "invitedFirmCities", label: "Invited firm cities" },
      { key: "invitedFirmContactNos", label: "Invited firm contact nos." },
      { key: "bidderFirmNames", label: "Bidder firm names" },
      { key: "bidderFirmUniqueNos", label: "Bidder firm unique nos." },
      { key: "bidderFirmEmails", label: "Bidder firm emails" },
      { key: "bidderFirmCities", label: "Bidder firm cities" },
      { key: "bidderFirmContactNos", label: "Bidder firm contact nos." },
    ],
  },
];
