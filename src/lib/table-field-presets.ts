...
export const tableFieldPresetGroups: TableFieldPresetGroup[] = [
  {
    ...
    fields: [
      ...
      { key: "receivedDate", label: "Demand received date" },
  ...
  },
  {
    ...
    fields: [
      { key: "gemBiddingMode", label: "GeM Bidding Mode" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "shortclosure", label: "Shortclosure (Yes/No)" },
      { key: "shortclosureDate", label: "Shortclosure date" },
  ...
  },
  {
    title: "Firm details",
    fields: [
      { key: "bqBasis", label: "BQ basis" },
      { key: "bqFirmNames", label: "BQ firm names" },
      { key: "bqFirmUniqueNos", label: "BQ firm unique nos." },
