...
create table app_settings (
  ...
  file_type_groups jsonb not null default '[{"fileType":"Goods & Services","group":"goodsServices"},{"fileType":"AMC","group":"contract"},{"fileType":"MPC","group":"contract"},{"fileType":"CARS","group":"contract"},{"fileType":"O&M","group":"contract"}]'::jsonb,
...
create table files (
  ...
  file_type_group text not null default 'goodsServices',
  mode text,
  gem text,
  gem_bidding_mode text,
  high_value text,
  ad text,
  rqa text,
  ifa text,
...
create table file_firms (
  id uuid primary key default gen_random_uuid(),
  file_id uuid not null references files(id) on delete cascade,
  firm_type text not null check (firm_type in ('bq', 'invited', 'bidder')),
  firm_name text,
  city text,
  address text,
  email_id text,
...
create table supply_orders (
  ...
  psb_bg_no text,
  psb_bg_amount numeric,
  psb_bg_received_date date,
  psb_bg_validity_date date,
  psb_bg_return_date date,
  pwb_bg_no text,
  pwb_bg_amount numeric,
  pwb_bg_received_date date,
  pwb_bg_validity_date date,
  pwb_bg_return_date date,
  combined_bg_no text,
  combined_bg_amount numeric,
